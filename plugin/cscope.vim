...
com! -nargs=?  -complete=dir Cl call ListDBs()
...
let s:cscope_vim_dir = $HOME."/.cscope.vim"
...
function! CreateCscopeDB(dir)
  ...
  let id = <SID>GetIndex(cwd)
  call <SID>_CreateCscopeDB(cwd, id)
endfunction
